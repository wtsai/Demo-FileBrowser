...
/**
 * Read the file / directory with current layer of folder
 * @param {String} dir          Basic or Root folder.
 ...
 */
var ReadDir = module.exports.ReadDir = function ReadDir( basic, dir, next, onFinish ){

    /*
	console.log( '[ReadDir]basic:' );
	console.log( basic );
	console.log( '[ReadDir]dir:' );
	console.log( dir );
    */
    dir = Path.resolve( basic + dir );
	console.log( '[ReadDir]final dir:' );
	console.log( dir );
 ...
 * @param {Function} onFinish   Called when the whole directory is finished reading.
 */
var RetrieveDir = module.exports.RetrieveDir = function RetrieveDir(  basic, dir, next, onFinish ){
 ...
 * @param next
 */
var RetrieveDirSync = module.exports.RetrieveDirSync = function( basic, dir, next, onFinish ){
